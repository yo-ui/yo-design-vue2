  ...
  computed: {
    ...
    iconClasses() {
      if (Number(this.type) === 0) {
        return {
          [{ true: [`yo-icon-radio-on`], false: [`yo-icon-radio-off`] }[
            this.model === this.label
          ]]: true
        };
      } else if (Number(this.type) === 1) {
        return {
          [{ true: [`yo-icon-radio1-on`], false: [`yo-icon-radio1-off`] }[
            this.model == this.label
          ]]: true
        };
      } else if (Number(this.type) === 2) {
        return {
          [{ true: [`yo-icon-radio2-on`], false: [`yo-icon-radio2-off`] }[
            this.model === this.label
          ]]: true
        };
      } else if (Number(this.type) === 3) {
        return {
          [{ true: [`yo-icon-radio11-on`], false: [`yo-icon-radio1-off`] }[
            this.model === this.label
          ]]: true
        };
      }
