/** author: eric * create at: 2020-01-15 00:03:52 */
<script>
...
export default {
  ...
  computed: {
    ...
    isDisabled() {
      return (
        (this.yoForm || {}).disabled ||
        (this.yoFormItem || {}).disabled ||
        (this.yoCheckboxGroup || {}).disabled ||
        this.disabled
      );
    },
    yoStyles() {
    ...
    iconClasses() {
      if (Number(this.type) === 0) {
        return {
          [{ true: [`yo-icon-checkbox-on`], false: [`yo-icon-checkbox-off`] }[
            this.model === this.label
          ]]: true
        };
      } else if (Number(this.type) === 1) {
        return {
          [{ true: [`yo-icon-checkbox1-on`], false: [`yo-icon-checkbox1-off`] }[
            this.model == this.label
          ]]: true
        };
      } else if (Number(this.type) === 2) {
        return {
          [{ true: [`yo-icon-checkbox2-on`], false: [`yo-icon-checkbox2-off`] }[
            this.model === this.label
          ]]: true
        };
        ...
        return {
          [{
            true: [`yo-icon-checkbox11-on`],
            false: [`yo-icon-checkbox1-off`]
