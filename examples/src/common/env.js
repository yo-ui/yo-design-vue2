...
const Constants = {
  ...
  LANGMAP: {
    ...
    EN: {
      ...
      name: "English",
      icon:
        process.env.VUE_APP_JS_SERVER + "/static/images/common/country/en.png",
      help: "en-us",
      coinpay: "EN"
    },
    KOREAN: {
      ...
      name: "한국어",
      icon:
        process.env.VUE_APP_JS_SERVER +
        "/static/images/common/country/korean.png",
      help: "korean",
      coinpay: "korean"
    },
    JAPANESE: {
      ...
      icon:
        process.env.VUE_APP_JS_SERVER +
        "/static/images/common/country/japanese.png",
      help: "japanese",
      coinpay: "japanese"
    },
    "ZH-CN": {
      ...
      icon:
        process.env.VUE_APP_JS_SERVER +
        "/static/images/common/country/zh-cn.png",
      help: "zh-cn",
      coinpay: "zh-cn"
    }
  },
