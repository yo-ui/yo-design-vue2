<template>
  <div id="app" :class1="(userInfo ? userInfo.pageUserTheme : '') + ' ' + lang">
    <keep-alive>
      <router-view class="flex-content-box"></router-view>
      <!-- <router-view class="flex-content-box" v-if="$route.meta.cache"></router-view> -->
    </keep-alive>
    <!-- <router-view class="flex-content-box" v-if="!$route.meta.cache"></router-view> -->
  </div>
</template>
